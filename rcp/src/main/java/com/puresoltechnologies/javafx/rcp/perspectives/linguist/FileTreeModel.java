...
class FileTreeModel implements TreeModel {
     ...
     * @throws IOException
     */
    private static Status getStatus(File file, Locale locale) throws IOException {
     ...
     * @throws IOException
     */
    private static void setStatusFlags(FileTree currentNode, Locale locale) throws IOException {
    ...
    public FileTreeModel(List<File> files, I18NProjectConfiguration configuration) throws IOException {
	super();
    ...
    public void setFiles(List<File> files, I18NProjectConfiguration configuration) throws IOException {
	this.configuration = configuration;
	setFileTree(files);
	setStatusFlags();
	fireStructureChanged();
	...
	if (fileTree != null) {
		...
		listener.treeStructureChanged(new TreeModelEvent(this, new TreePath(fileTree)));
	    }
	}
    }
	...
	for (TreeModelListener listener : listeners) {
	    listener.treeNodesChanged(new TreeModelEvent(this, new TreePath(fileTree.getFileTreeElement(file))));
	}
    }
