...
public class I18N4Java {
    ...
    static {
	try {
	    InputStream inputStream = I18N4Java.class.getResourceAsStream("/config/i18n4java.properties");
	    if (inputStream != null) {
		try {
		    Properties properties = new Properties();
		    properties.load(inputStream);
		    String language = (String) properties.get("i18n4java.implementation.language");
		    String country = (String) properties.get("i18n4java.implementation.country");
		    String variant = (String) properties.get("i18n4java.implementation.variant");
		    if ((language != null) && (!language.isEmpty())) {
			if ((country != null) && (!country.isEmpty())) {
			    if ((variant != null) && (!variant.isEmpty())) {
				implementationLocale = new Locale(language, country, variant);
			    } else {
	...
	List<String> isoLanguages = new ArrayList<>();
	...
	List<Locale> isoLanguages = new ArrayList<>();
