...
public class MessageFormatTest {
	...
	assertEquals("Der Benutzer Test Test2 mit der ID 2 existiert bereits!",
		new MessageFormat("Der Benutzer {0} {1} mit der ID {2,number,integer} existiert bereits!",
			new Locale("de", "DE")).format(test));
	assertEquals("Der Benutzer Test Test2 mit der ID 2 existiert bereits!",
		this.tr("Der Benutzer {0} {1} mit der ID {2,number,integer} existiert bereits!", "Test", "Test2", 2));
    }
}
