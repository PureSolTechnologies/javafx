...
import com.puresoltechnologies.javafx.charts.plots.AbstractLinePlot;
...
public class XYPlot<X extends Number & Comparable<X>, Y extends Number & Comparable<Y>>
        extends AbstractLinePlot<X, Y, XYValue<X, Y>> {
    ...
    public PlotRenderer<X, Y, XYValue<X, Y>, ? extends AxisRenderer<X>, ? extends AxisRenderer<Y>> getRenderer(
        ...
        PlotRenderer<X, Y, XYValue<X, Y>, ? extends AxisRenderer<X>, ? extends AxisRenderer<Y>> renderer = new XYPlotRenderer<>(
