    ...
    public void scale(double factor, double ratioMinToMax) {
        ...
        if ((min != null) && (max != null)) {
            if (Double.class.isAssignableFrom(min.getClass())) {
                ...
                min = (T) Double.valueOf(newMin);
                max = (T) Double.valueOf(newMax);
                ...
                min = (T) Byte.valueOf(newMin);
                max = (T) Byte.valueOf(newMax);
                ...
                min = (T) Short.valueOf(newMin);
                max = (T) Short.valueOf(newMax);
                ...
                min = (T) Integer.valueOf(newMin);
                max = (T) Integer.valueOf(newMax);
                ...
                min = (T) Long.valueOf(newMin);
                max = (T) Long.valueOf(newMax);
            }
            setMin(min);
            setMax(max);
    ...
    public void move(double fractionOfRange) {
        ...
        if ((min != null) && (max != null)) {
            if (Double.class.isAssignableFrom(min.getClass())) {
                ...
                min = (T) Float.valueOf(newMin);
                max = (T) Float.valueOf(newMax);
            } else if (Byte.class.isAssignableFrom(min.getClass())) {
                byte range = (byte) (max.byteValue() - min.byteValue());
