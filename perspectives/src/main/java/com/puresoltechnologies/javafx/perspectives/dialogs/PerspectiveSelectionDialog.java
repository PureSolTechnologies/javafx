...
public class PerspectiveSelectionDialog extends Dialog<Perspective> {
    ...
    static {
	try {
	    iconSmall = ResourceUtils.getImage(Perspective.class, "icons/FatCow_Icons16x16/switch_windows.png");
	    iconBig = ResourceUtils.getImage(Perspective.class, "icons/FatCow_Icons32x32/switch_windows.png");
	} catch (IOException e) {
